       ...
       <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                %>
                <tr>
                  <td><%=activityInstance.getId() %></td>
                  <td><a href="listTask.jsp?activityInstanceId=<%=activityInstance.getId() %>&processInstanceId=<%=processInstId%>"><%=activityInstance.getActivityDefinitionId() %></a></td>
                  <td><%=activityInstance.getName() %></td>
                  <td><%=activityInstance.getProcessDefinitionId() %></td>
                  <td><%=ConstantsUtil.getStateString(activityInstance.getState()) %></td>
                  <td><%=activityInstance.getCreateDate() %></td>
                  <td><%=activityInstance.getModifyDate()%></td>
                </tr>
                <%
                }
                %>
