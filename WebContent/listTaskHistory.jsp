...
ActivityHistory activityHistory = runtimeService.loadActivityHistory(Long.parseLong(activityInstId));
List<TaskHistory> taskList =  runtimeService.listTaskHistoryByActivityInstId(Long.parseLong(activityInstId));
...
<div class="wrapper">
        ...
        <li class="header">
	        ...
	        <li><a href="listMyTask.jsp"><i class="fa fa-book"></i> <span>代办任务</span></a></li>
	         ...
	         <li class="treeview active">
	          ...
	          <ul class="treeview-menu">
	          	<li class="active"><a href="listMyProcessHistory.jsp"><i class="fa fa-circle-o"></i> 已建流程</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        工作项历史
        <small>指定活动历史下的，工作项历史列表</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="listMyProcessHistory.jsp"><i class="fa fa-dashboard"></i> 流程实例</a></li>
        <li><a href="listActivityHistory.jsp?processInstanceId=<%=processInstId%>"><i class="fa fa-dashboard"></i> 活动实例</a></li>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              %>
		              ...
		              <div class="alert alert-info alert-dismissible">
		                ...
		                该活动下没有工作项。可能该活动[<%=activityHistory.getActivityDefinitionId()%>]不是人工活动，则无需产生任务。
		              </div>
            <%
              }else{
            %>
				              <table class="table table-hover">
				                ...
				                <%
				                for(TaskHistory taskHistory : taskList){
				                	
				                %>
				                <tr>
				                  <td><%=taskHistory.getId() %></td>
				                  <td><%=taskHistory.getName() %></td>
				                  <td><%=taskHistory.getUserId() %></td>
				                  <td><%=taskHistory.getProcessInstanceId() %></td>
				                  <td><%=taskHistory.getProcessDefinitionId() %></td>
				                  <td><%=ConstantsUtil.getStateString(taskHistory.getState()) %></td>
				                  <td><%=taskHistory.getCreateDate() %></td>
				                  <td><%=taskHistory.getCompleteDate() %></td>
				                </tr>
				                <%
				                }
				                %>
